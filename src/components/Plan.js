...
const Plan = ({nextStep, handleChange, step, values}) => {
  ...
  return (
    <>
    <Container className = "marginAndPadding" component = 'main' style={{    width: "100vw"
    }} >
      <NavBar
       nextStep = {nextStep}
       values = {values}
       ...
       <Grid container spacing = {2} >
          ...
          <Grid item xs={12} sm={12}>
              ...
              <Typography inline variant="body1" align="left" >
                Increase yours and your family health cover insurance cover by &#8377; 20 lakhs with
              </Typography>
              <Typography inline variant="body1" align="left" >
                Super top-up!
              </Typography>
          ...
          <path d="M11.9999 10.0879C13.4201 10.0879 14.5713 9.02521 14.5713 7.71429H9.42847C9.42847 9.02521 10.5797 10.0879 11.9999 10.0879Z" fill="#2D3D54"/>
                          ...
                          <Grid item xs={4} sm={4}>
                          <Typography align='right'>&#8377; 0000</Typography>
                          </Grid>
                        </Grid></MenuItem>
